...
describe("manage_telegram_group.update_policy", () => {
  ...
  it.each([
    { action: "update_policy", messageMode: "all", telegramChatId: "-1001000000001" },
    { action: "update_policy", telegramChatId: "-1001000000001", toolAllowlist: [] },
    { action: "update_policy", messageMode: "all", toolAllowlist: [] },
    { ...input, title: "Новое название" },
    { ...input, type: "external" },
    { ...input, telegramChatId: -1001000000001 },
