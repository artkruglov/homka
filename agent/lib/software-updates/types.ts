...
/** Тихие часы не часть привязки предложения к владельцу: их знает только тот, кто его начинает. */
export type SoftwareUpdateRecipient = QuietHours & SoftwareUpdateOwner;
...
export interface SoftwareUpdateRepository {
  ...
  findCurrentOwner(): Promise<SoftwareUpdateRecipient | null>;
