...
import { requireBoundDestinationSpace } from "../spaces/space-write.js";
      ...
      const inserted = await client.query<{ id: string }>(
        `INSERT INTO agent_schedules
           (family_id, owner_user_id, author_user_id, group_id, scope, title,
            ...
            forum_topic_id, history_window_days, tool_allowlist, space_id)
         VALUES ($1, NULL, $2, $3, 'group', $4, $5, $6, $7, $8, $9, $10,
                 $11::timestamptz AT TIME ZONE $7, $11, $12, $13, NULL, NULL, $14, $15, $16)
         RETURNING id`,
        [
          auth.familyId,
          auth.requestedBy,
          ...
          historyWindowDays,
          capabilityAllowlist,
          await requireBoundDestinationSpace(client, auth.familyId, group.id),
        ],
      );
