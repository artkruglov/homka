...
import { readSpaceAttributes, type SpaceAttributes } from "../spaces/space-attributes.js";
...
export function requireAgentScheduleAuthorization(
  ...
  const space = readSpaceAttributes(attributes, "AGENT_SCHEDULE_CONTEXT_INVALID");
  return {
    ...(space ? { space } : {}),
