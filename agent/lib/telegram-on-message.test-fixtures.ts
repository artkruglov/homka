...
export function repositories() {
  ...
  return {
    ...
    attachments: {
      inspect: vi.fn().mockResolvedValue({ analysis: "На фото красная кружка." }),
    ...
    spaces: {
      resolveTelegramChatMode: vi.fn().mockResolvedValue("legacy"),
      resolveTurnSpace: vi.fn().mockResolvedValue(null),
    },
    telegram: {
